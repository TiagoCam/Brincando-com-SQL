...
SELECT ROUND(AVG(SAL),2) AS MEDIA_SALARIOS FROM EMP;

SELECT LENGTH(ENAME) FROM EMP;

SELECT ENAME, AS NOME, LENGTH(ENAME) AS QTD_CARCTERES FROM EMP;

SELECT ENAME AS NOME, LENGTH(ENAME) AS QTD_CARCTERES FROM EMP;

SELECT ENAME AS NOME, LENGTH(ENAME) AS QTD_CARCTERES FROM EMP WHERE JOB='ANALYST';

SELECT ENAME AS NOME, LENGTH(ENAME) AS QTD_CARCTERES FROM EMP;

SELECT ENAME AS NOME, LENGTH(ENAME) AS QTD_CARCTERES FROM EMP WHERE JOB='ANALYST' ORDER BY ENAME;

SELECT * FROM EMP;

SELECT JOB, MAX(SAL) FROM EMP GROUP JOB;
...
SELECT DEPTNO, JOB, MAX(SAL) FROM EMP GROUP BY JOB ORDER BY DEPTNO;
